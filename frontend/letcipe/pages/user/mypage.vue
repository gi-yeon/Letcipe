        ...
        <div class="user-section">
            ...
            <v-row style="padding: 0%">
              ...
              <v-col cols="6" style="margin: auto"
                ><v-row style="font-size: 18px"
                  >&nbsp;{{ nickname }}ㅡㅡㅡㅡ</v-row
                ><v-row style="font-size: 13px">&nbsp;{{ job }}</v-row></v-col
              >
              <v-col cols="3" style="margin: auto"
                ><v-btn outlined small rounded style="margin: 0px; color: black"
                  >내 정보</v-btn
                ></v-col
              >
            </v-row>
            ...
            ><div class="list-btns">
              <v-row style="margin: auto"
                ...
                ><v-col style="margin: auto"
                  ><v-icon class="menu-icon">mdi-cart</v-icon> 장보기목록</v-col
                ></v-row
              >
            </div></v-container
          >
          ...
          <v-container style="padding: 0rem; margin: auto"
            ><v-row style="margin: auto; text-align: center">
              <v-col cols="3"
                ><v-icon x-large class="menu-icon"
              ...
              >
              <v-col cols="3"
                ><v-icon x-large class="menu-icon">mdi-noodles</v-icon></v-col
              >
              <v-col cols="3"
                ><v-icon x-large class="menu-icon">mdi-history</v-icon></v-col
              > </v-row
            ><v-row style="margin: auto; text-align: center; display: flex">
              <v-col cols="3" class="menu-title"
                >즐겨찾는<br />레시피리스트</v-col
              >
              <v-col cols="3" class="menu-title"
                >내가 만든<br />레시피리스트</v-col
              >
              <v-col cols="3" class="menu-title">내가 만든<br />레시피</v-col>
              <v-col cols="3" class="menu-title">히스토리</v-col>
            </v-row>
            <br />
            <v-row style="margin: auto; text-align: center">
              <v-col cols="3"
              ...
              > </v-row
            ><v-row style="margin: auto; text-align: center; display: flex">
              <v-col cols="3" class="menu-title">즐겨찾는<br />레시피</v-col>
              <v-col cols="3" class="menu-title">좋아요한<br />레시피</v-col>
