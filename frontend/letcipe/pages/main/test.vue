    ...
    <div class="additional">
      <div class="user-card">
        ...
        >
          ...
          <desc id="desc">
            Cartoon of a Caucasian woman smiling, and wearing black glasses and
            a purple shirt with white collar drawn by Alvaro Montoro.
          </desc>
...
export default {
  ...
  data() {
    return {
      user: '렛싸피',
      refImg: [
        'data/recipe/20210810152825-4Y20E.jpg',
        'data/recipe/20210810142007-EYPBD.jpg',
        'data/recipe/20210713113307-VT9JZ.jpg',
        'data/recipe/20210708104052-PX6S9.jpg',
        'data/recipe/20220825153420-BD8U3.png',
      ],
      width: 0,
      height: 0,
      mouseX: 0,
