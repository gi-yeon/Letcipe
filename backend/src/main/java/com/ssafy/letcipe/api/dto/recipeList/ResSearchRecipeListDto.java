...
import com.ssafy.letcipe.api.dto.recipeListItem.ResRecipeListItemDto;
...
public class ResSearchRecipeListDto {
    private Long id;
    ...
    private List<ResRecipeListItemDto> recipeListItems;

    public ResSearchRecipeListDto(RecipeList recipeList){
        ...
        for (RecipeListItem recipeListItem : recipeList.getRecipeListItems()){
            recipeListItems.add(new ResRecipeListItemDto(recipeListItem));
        }
    }
}
