...
public interface RecipeListRepository extends JpaRepository<RecipeList, Long> {
    ...
    @Query("select b.recipeList from RecipeListBookmark b where (b.recipeList.isDeleted = 0 and b.recipeList.isShared = 1) group by b.recipeList order by count(b.recipeList) desc")
