...
public class Driver {
	public static void main(String[] args) {
		...
		try {
			...
			pgd.addClass("wordcount1char", Wordcount1char.class, "A map/reduce program that counts the 1st character of wors in the input files");
			...
			pgd.addClass("matrix", MatrixAdd.class, "A map/reduce program that computes the addition of two matrices.");
      			pgd.driver(args);
			exitCode = 0;
		}
		catch(Throwable e) {
